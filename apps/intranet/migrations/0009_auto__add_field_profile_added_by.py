...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.added_by'
        db.add_column(u'intranet_profile', 'added_by',
                      self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.added_by'
        db.delete_column(u'intranet_profile', 'added_by')
    ...
    models = {
        ...
        u'intranet.profile': {
            ...
            'added_by': ('django.db.models.fields.IPAddressField', [], {'max_length': '15'}),
            ...
            'steam_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
