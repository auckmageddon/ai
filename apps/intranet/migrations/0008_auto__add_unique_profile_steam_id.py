...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Profile', fields ['steam_id']
        db.create_unique(u'intranet_profile', ['steam_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['steam_id']
        db.delete_unique(u'intranet_profile', ['steam_id'])
