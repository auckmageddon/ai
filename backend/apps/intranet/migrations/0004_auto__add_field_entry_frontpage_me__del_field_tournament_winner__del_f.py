...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.frontpage_me'
        db.add_column('intranet_entry', 'frontpage_me',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Tournament.winner'
        db.delete_column('intranet_tournament', 'winner')

        # Deleting field 'Tournament.game'
        db.delete_column('intranet_tournament', 'game')


    def backwards(self, orm):
        # Deleting field 'Entry.frontpage_me'
        db.delete_column('intranet_entry', 'frontpage_me')


        # User chose to not deal with backwards NULL issues for 'Tournament.winner'
        raise RuntimeError("Cannot reverse this migration. 'Tournament.winner' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Tournament.game'
        raise RuntimeError("Cannot reverse this migration. 'Tournament.game' and its values cannot be restored.")
